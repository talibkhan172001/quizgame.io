...
int main()
    ...
    printf("\n\n Here are some tips you can know before playing:");
    printf("\n -------------------------------------------------------------------------");
...
game:
     ...
     switch(r)
		{
		case 1:
		printf("\n\nWhichs is the National Game of England?");
	...
	if(score>0.00 && score<=900000)
	{
	     printf("\n\t You won $%.2f",score);goto go;}

	 else if(score>900000.00 && score<2300000)
	{
	    printf("\n\n\n \t\t**************** CONGRATULATION ****************");
